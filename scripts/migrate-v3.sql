-- Migration v3: 6-axis percentage scoring + Observer level
-- Run in Supabase SQL Editor

-- 1. Reset community_stats with new axis names
UPDATE community_stats SET
  n = 0, sum_exposure = 0, sum_readiness = 0,
  sum_scores = '{"adoption":0,"mindset":0,"craft":0,"tech_depth":0,"reliability":0,"agents":0}',
  archetype_counts = '{}',
  exposure_buckets = '{"low":0,"moderate":0,"high":0}',
  readiness_buckets = '{"early":0,"building":0,"strong":0}',
  tool_counts = '{}', tool_users = 0, answer_counts = '{}',
  updated_at = now()
WHERE id = 1;
