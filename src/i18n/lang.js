...
const LANGS = {
  en: {
    ...
    welcome_subtitle: "A quick assessment to see where you stand with AI — discover your strengths, gaps, and actionable next steps.",
    ...
    research_note: "Data references:",
    research_sources: "WEF, Deloitte, McKinsey, ManpowerGroup, Forbes and other public industry reports.",
    ...
    dim_mindset: "Mindset",
    dim_craft: "Craft",
    dim_tech_depth: "Tech Depth",
    dim_reliability: "Reliability",
    dim_agents: "Agents",
    evolution_title: "🗺️ Your Position on the AI Evolution Map",
    detected_title: "🔍 What We Detected",
  ...
  cn: {
    ...
    welcome_subtitle: "快速评估你的 AI 使用阶段，发现优势和短板，获得可落地的成长建议。",
    ...
    research_note: "数据参考：",
    research_sources: "世界经济论坛、德勤、麦肯锡、万宝盛华、福布斯等公开行业报告。",
    ...
    dim_reliability: "可靠性",
    dim_agents: "智能体",
    evolution_title: "🗺️ 你在 AI 进化地图上的位置",
    detected_title: "🔍 我们检测到的特征",
    blind_spot: "盲点",
    legend_you: "你",
