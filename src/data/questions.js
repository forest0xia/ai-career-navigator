...
const QUESTIONS = [
  ...
  // === AI TOOLS (2 questions, including multi-select) ===
  {
    ...
    options: [
      { text: "ChatGPT / GPT-4", toolCategory: "general" },
      ...
      { text: "GitHub Copilot / Cursor / Windsurf", toolCategory: "coding" },
      { text: "Amazon Q / CodeWhisperer", toolCategory: "coding" },
      { text: "Midjourney / DALL-E / Stable Diffusion", toolCategory: "creative" },
      { text: "Adobe Firefly / Canva AI", toolCategory: "creative" },
      { text: "Jasper / Copy.ai / Writesonic", toolCategory: "writing" },
      { text: "Notion AI / Grammarly AI", toolCategory: "productivity" },
      { text: "Perplexity / AI search tools", toolCategory: "research" },
      { text: "Zapier AI / Make.com / automation agents", toolCategory: "automation" },
      { text: "Runway / Suno / ElevenLabs (video/audio)", toolCategory: "creative" },
      { text: "Custom GPTs / AI agents I've built myself", toolCategory: "advanced" },
